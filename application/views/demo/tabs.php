                    ...
                    <div class="col-md-6">
                        <div class="card-box">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="active"><a href="#basictab1" data-toggle="tab">Home</a></li>
                                <li><a href="#basictab2" data-toggle="tab">Profile</a></li>
                                <li><a href="#basictab3" data-toggle="tab">Messages</a></li>
                            </ul>
                    ...
                    <div class="col-md-6">
                        <div class="card-box">
                            ...
                            <ul class="nav nav-tabs nav-justified">
                                <li class="active"><a href="#basic-justified-tab1" data-toggle="tab">Home</a></li>
                                <li><a href="#basic-justified-tab2" data-toggle="tab">Profile</a></li>
                                <li class="dropdown">
